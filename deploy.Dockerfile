...
COPY --chown=cherrypick:cherrypick --from=native-builder /cherrypick/packages/cherrypick-js/node_modules ./packages/cherrypick-js/node_modules
...
ENV CLIENT_ASSETS_BASE_URL=${ARGS_CLIENT_ASSETS_BASE_URL}
